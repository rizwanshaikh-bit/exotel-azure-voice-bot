...
GET
/api/v1/bots
Lists all defined Bot Profiles.
9
Get Bot
GET
/api/v1/bot/{id}
Returns the full Bot definition.
10
Create Bot
POST
/api/v1/bot
Combines: Prompt, Voice, and SMS into an ID.
...
GET
api/v1/sms
Retrieves all available SMS templates.
12
Get SMS
GET
api/v1/sms/{id}
Fetches details of a specific SMS template.
13
Create/Update SMS
POST
api/v1/sms
Creates a new SMS template or updates existing one.
...
GET
api/v1/campaigns
Lists all outbound campaigns.
15
Get Campaign
GET
api/v1/campaign/{id}
Returns metadata, status, and assigned Exophone.
16
Create Campaign
POST
api/v1/campaign
Combines: Bot ID + Exophone + Schedule.
17
Upload Base Data
POST
api/v1/campaign/data
Uploads CSV records for a campaign.
18
Start Campaign
POST
api/v1/campaign/run
Triggers the ThreadPool loop (eg: 100 calls/min).
